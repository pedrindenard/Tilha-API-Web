                ...
                (posicao, produtoEscolhido) -> {
                    repository.remove(produtoEscolhido,
                        new ProdutoRepository.DadosCarregadosCallback<Void>() {
                            ...
                            @Override
                            public void quandoFalha(String erro) {
                                Toast.makeText(ListaProdutosActivity.this, "Não foi possivel remover o produto", Toast.LENGTH_SHORT).show();
                            }
                        });
                });
    }
    ...
    private void abreFormularioEditaProduto(int posicao, Produto produto) {
        new EditaProdutoDialog(this, produto,
                produtoEditado -> repository.edita(produtoEditado, new ProdutoRepository.DadosCarregadosCallback<Produto>() {
                    ...
                    @Override
                    public void quandoFalha(String erro) {
                        Toast.makeText(ListaProdutosActivity.this, "Nâo fooi possivel editar o produto", Toast.LENGTH_SHORT).show();
                    }
                }))
                .mostra();
    }
